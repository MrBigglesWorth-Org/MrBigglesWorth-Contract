...
contract Bigglesworth is Context, IERC20, Ownable, SafeToken, LockToken {
    ...
    address payable public _marketingWallet =
        payable(0x618CaFDD7b331120b48F1187B2e6eD2EbD71651A);
    ...
    string private _name = "Mr. Bigglesworth";
    string private _symbol = "BIGGLES";
    ...
    function swapTokens(uint256 contractTokenBalance) private lockTheSwap {
        ...
        transferToAddressETH(
            _marketingWallet,
            transferredBalance.div(_totalFee).mul(_marketingFee)
        );
    }
